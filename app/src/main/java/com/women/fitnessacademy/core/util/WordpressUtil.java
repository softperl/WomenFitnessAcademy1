...
import com.women.fitnessacademy.core.data.model.Author;
...
import com.women.fitnessacademy.core.data.model.Image;
    ...
    public static List<Post> getPosts(JSONArray data) throws JSONException {
        ...
        for (int i = 0; i < data.length(); i++) {
            ...
            if (featuredMedia != null) {
                if (featuredMedia.getJSONObject(0).has(Constants.POST_SOURCE_URL_KEY)) {
            ...
            if (mAuthor.has(Constants.AUTHOR_AVATAR_URLS_KEY)) {
