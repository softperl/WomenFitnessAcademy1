...
import com.women.fitnessacademy.core.ui.contracts.CommentsContract;
import com.women.fitnessacademy.core.ui.presenters.CommentsPresenter;
import com.women.fitnessacademy.views.adapters.CommentsAdapter;
...
public class CommentsActivity extends BaseActivity implements CommentsContract.CommentsView {
    ...
    private void checkLogin() {
        if (!Config.LOGIN_ENABLED) {
            commentsTicker.setVisibility(View.GONE);
