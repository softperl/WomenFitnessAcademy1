...
import com.women.fitnessacademy.core.ui.contracts.SinglePostContract;
import com.women.fitnessacademy.core.ui.presenters.SinglePostPresenter;
import com.women.fitnessacademy.core.util.WordpressUtil;
import com.women.fitnessacademy.views.adapters.PhotosAdapter;
import com.women.fitnessacademy.views.adapters.VideosAdapter;
import com.women.fitnessacademy.views.custom.GridSpacingItemDecoration;
import com.women.fitnessacademy.views.util.widgets.ytplayer.YouTubePlayerActivity;
    ...
    private void setAdBanner() {
        if (Config.ABMOB_APP_ID != null && Config.ADMOB_AD_UNIT_ID != null) {
            if (!Config.ABMOB_APP_ID.isEmpty() && !Config.ADMOB_AD_UNIT_ID.isEmpty()) {
                ...
                AdView adView = new AdView(PostDetailActivity.this);
            ...
            public void run() {
                if (post.getContent() != null & !post.getContent().isEmpty()) {
                    ...
                    if (Config.VISUAL_COMPOSER_RENDER) {
                        ...
                        String style = "<style>img{display: inline; height: auto; max-width: 100%;}" +
                                " iframe {display: inline;height:auto;max-width:100%;}" +
                                ".wp-video {display: inline; max-width: 300px; height: 200px; width: 300px !important; margin: auto !important;}" +
                                ".mejs-container {display: inline; width: 300px !important; height: 200px !important; margin: auto !important;}</style>";
